...
$(document).ready(function(){
	...
	var svg = $('#svg').svg('get');
	linie[0] = svg.line(0, 200, 75, 200, {stroke: 'blue'});
	linie[1] = svg.line(75, 200, 150, 200, {stroke: 'blue'});
	...
	$("#SliderChange").mousemove(function(){
		$("#ValueSlider").val($("#SliderChange").val());
	});
...
function CreateRobots(){
	...
	this.aktualizuj = function(coord) {
		...
		linie[0] = svg.line(this.positionArm.x0, this.positionArm.y0, this.positionArm.x1, this.positionArm.y1, {stroke: 'blue'});
